    ...
    <div className="about" id="about">
      <div className="container">
        ...
        <div className="col-2">
          ...
          <p>Whilst I have learnt a lot on the bootcamp I feel like I have barely scratched the surface! As tech continues to grow exponentially I too want to grow my knowledge and I'm excited to see where this journey takes me!</p>
